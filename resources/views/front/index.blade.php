            ...
            <div class="slick2">
                @foreach($posts as $post)
                    <div class="slick-cont">
                        <div class="card">
                            <img src="/BloodBank2021/public/storage/posts_images/{{$post->image}}" class="card-img-top" alt="slick-img">
            ...
            <div class="row">
                <div class="contact-info col-md-6 col-sm-12 text-center">
                    ...
                    <div class="phone-nm mx-auto">
                        <p class="text-right"><a href="https://api.whatsapp.com/send?phone={{$settings->first()-> whats_link}}">{{$settings->first()->whats_link}} </a></p>
